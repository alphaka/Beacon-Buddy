...
const SearchingBarProgressBar1 = () => {
    ...
    <View style={styles.searchingBarProgressBar}>
      <View style={styles.hello}>
        ...
        <View style={styles.groupView1}>
          ...
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/more8.png")}
          />
                    ...
                    <View style={styles.labelIconLeft}>
                      <View style={styles.placeholder}>
                        <Image
                          ...
                          resizeMode="cover"
                          source={require("../assets/wrapper257.png")}
                        />
                      </View>
                  ...
                  <View style={styles.labelIconLeftChevron1}>
                    ...
                    <View style={styles.labelIconLeft1}>
                      <Image
                        ...
                        resizeMode="cover"
                        source={require("../assets/players-icon12.png")}
                      />
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/rectangle-copy15.png")}
        />
        <Image
      ...
      <View style={styles.beaconReady}>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/rectangle-copy16.png")}
        />
        <Image
          style={styles.rectangleCopyIcon2}
          resizeMode="cover"
          source={require("../assets/rectangle-copy17.png")}
        />
        <Image
          style={styles.rectangleCopyIcon3}
          resizeMode="cover"
          source={require("../assets/rectangle-copy18.png")}
        />
        <Image
...
export default SearchingBarProgressBar1;
