...
const PendingRoster = () => {
  return (
    <View style={styles.pendingRoster}>
      <View style={styles.hello}>
          ...
          <View style={styles.imageCircle}>
            ...
            >
              ...
              <View style={styles.badge2}>
                <Text style={styles.badge1}>85</Text>
              </View>
            </ImageBackground>
          </View>
        ...
        <View style={styles.elementsTextBoxNavBar2}>
          <Text style={styles.title3}>Request Pending</Text>
        </View>
        <View style={styles.elementsTextBoxNavBar3}>
          <Text style={styles.title4}>Active Roster ( 3 / 6)</Text>
        </View>
          ...
          <View style={styles.imageCircle1}>
            ...
            >
              ...
              <View style={styles.badge5}>
                <Text style={styles.badge4}>Host</Text>
              </View>
            </ImageBackground>
          </View>
          <View style={[styles.elementsTextBoxTableRow1, styles.mt10]}>
            <Text style={styles.title5}>{`Brian `}</Text>
            ...
            <View style={styles.imageCircle3}>
              ...
              >
                ...
                <View style={styles.badge10}>
                  <Text style={styles.badge9}>Adv.</Text>
                </View>
              </ImageBackground>
            </View>
            <View style={[styles.elementsTextBoxTableRow2, styles.mt10]}>
              <Text style={styles.title6}>Paul</Text>
        ...
        <View style={styles.author4}>
          <View style={styles.imageCircle4}>
            ...
            >
              ...
              />
              <Image
                style={styles.unsplasharxIJ2pWXXcIcon1}
                resizeMode="cover"
                source={require("../assets/unsplasharxij2pwxxc.png")}
              />
              ...
              <LinearGradient
                style={styles.badge13}
                locations={[0, 1]}
                colors={["#0061c8", "#5aedff"]}
              >
                <Text style={styles.badge12}>Me</Text>
              </LinearGradient>
            </ImageBackground>
          </View>
          <View style={[styles.elementsTextBoxTableRow3, styles.mt10]}>
            <Text style={styles.title7}>Fatima</Text>
      ...
      <Pressable style={styles.button}>
        <LinearGradient
          ...
          colors={["#0061c8", "#5aedff"]}
        />
        <Text style={styles.login}>Cancel Request</Text>
      </Pressable>
      <View style={styles.more}>
        ...
        <View style={styles.logoBeacon}>
          ...
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/vector-522.png")}
          />
