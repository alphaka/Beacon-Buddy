    ...
    <View style={styles.roster}>
      <View style={styles.hello}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("RosterConfirmation")}
        >
          <View style={styles.imageCircle1}>
            ...
            >
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/multimedia--image22.png")}
              />
              <Image
              ...
              <View style={styles.badge5}>
                <Text style={styles.badge4}>Beg.</Text>
              </View>
            </ImageBackground>
          </View>
        ...
        <View style={styles.elementsTextBoxNavBar3}>
          <Text style={styles.title6}>Pending Requests ( 1 )</Text>
        </View>
          ...
          <View style={styles.imageCircle5}>
            ...
            >
              ...
              <View style={styles.badge16}>
                <Text style={styles.badge15}>Adv.</Text>
              </View>
            </ImageBackground>
          </View>
            ...
            <View style={styles.imageCircle6}>
              ...
              >
                ...
                <View style={styles.badge19}>
                  <Text style={styles.badge18}>85</Text>
                </View>
              </ImageBackground>
            </View>
      ...
      <View style={styles.address}>
        <View style={styles.components2}>
          <View style={styles.master2}>
            ...
            <View style={[styles.placeholder11, styles.ml6]}>
              <Image
