                ...
                <View style={styles.controlFrame}>
                  <View style={styles.chevron}>
                    <View style={styles.content}>
                      <Text style={styles.detail}>2:00PM</Text>
                      <Text style={[styles.info, styles.mt2]}>
                        <Text style={styles.aCTIVE}>ACTIVE</Text>
                        <Text style={styles.text1}>12/21</Text>
                      </Text>
                    </View>
                  </View>
                </View>
              ...
              <View style={styles.elementsLines2}>
                <View style={styles.topLine1}>
                  <Image
                    ...
                    resizeMode="cover"
                    source={require("../assets/line-solid6.png")}
                  />
                </View>
              </View>
              <View style={styles.iconSpacing1}>
                ...
                <View style={styles.placeholder7}>
                  <Image
                    ...
                    resizeMode="cover"
                    source={require("../assets/wrapper230.png")}
                  />
                </View>
              </View>
              <View style={styles.elementsLines3}>
                <View style={styles.bottomLine1}>
                  <Image
                    ...
                    resizeMode="cover"
                    source={require("../assets/line-solid7.png")}
                  />
                </View>
              </View>
            </View>
                  ...
                  <View style={styles.chevron1}>
                    <View style={styles.content2}>
                      ...
                      <Text style={[styles.info1, styles.mt2]}>
                        <Text style={styles.aCTIVE2}>
                          <Text style={styles.aCTIVE1}>ACTIVE</Text>
                        </Text>
                    ...
                    <View style={styles.labelIconLeft3}>
                      <View style={styles.placeholder10}>
                        <Image
                          ...
                          resizeMode="cover"
                          source={require("../assets/wrapper233.png")}
                        />
                      </View>
        ...
        <View style={styles.imageCircle}>
          <View style={styles.image}>
            ...
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/placeholder21.png")}
            />
        ...
        <View style={styles.imageCircle1}>
          <View style={styles.image1}>
            ...
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/placeholder22.png")}
            />
