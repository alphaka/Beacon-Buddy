...
const BeaconSubmissionPlayer = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.beaconSubmissionPlayer}>
      <View style={styles.hello}>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/not-ready-beacon13.png")}
        />
          ...
          <View style={styles.line2}>
            <View style={styles.components}>
              <View style={styles.master}>
                ...
                <Text style={[styles.label, styles.ml6]}>
                  Dec 22 | 5:30 - 6:30PM
                </Text>
            ...
            <Pressable style={[styles.placeholder7, styles.ml10]}>
              <Image
                ...
                <View style={styles.searchField}>
                  <View style={styles.iconText}>
                    ...
                    <Text style={[styles.placeholderLabel, styles.ml10]}>
                      Central Park, Court 13, New York
                    </Text>
                  </View>
                  <Image
...
export default BeaconSubmissionPlayer;
