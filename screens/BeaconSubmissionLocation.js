...
const BeaconSubmissionLocation = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.beaconSubmissionLocation}>
      ...
      >
        <View style={styles.image2}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/multimedia--image5.png")}
          />
          <Image
...
export default BeaconSubmissionLocation;
