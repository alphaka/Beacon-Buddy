...
const ActiveReceiverRosterCance = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.activeReceiverRosterCance}>
          ...
          <View style={styles.components}>
            <View style={styles.master}>
              ...
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/wrapper127.png")}
              />
            </View>
          </View>
          ...
          <View style={styles.components1}>
            <View style={styles.master1}>
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/sports--basket-ball3.png")}
              />
        ...
        <View style={styles.author1}>
          <View style={styles.imageCircle1}>
            ...
            >
              ...
              >
                <Text style={styles.badge4}>Me</Text>
              </LinearGradient>
            </ImageBackground>
          </View>
...
export default ActiveReceiverRosterCance;
